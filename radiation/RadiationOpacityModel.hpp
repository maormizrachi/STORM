...
public:
    ...
    virtual double CalcPlanckOpacityAtTemperature(const CellT &cell,
                                                  double temperature)
    {
        (void) temperature;
    ...
    virtual double CalcAbsorptionOpacityAtTemperature(
        const CellT &cell, double frequency, double temperature)
    {
        (void) temperature;
    ...
    virtual double CalcScatteringOpacityAtTemperature(
        const CellT &cell, double temperature)
    {
        (void) temperature;
        return this->CalcScatteringOpacity(cell);
    }
